/*
    200mainAbstracted.c
    Implements a vertex shader, shadeVertex(), which copies attributes to varyings, after applying a transformation to the vertex's x and y coordinates.
	Demo features a quadrilateral rotating/oscillating (without clearing pixels between frames).
