/*
    220mainAbstracted.c
    Demo showing that implementations of function pointers in shaShading struct work properly. Features a rotating ellipse revolving around the center of the window, with animated color.
...
On Ubuntu, compile with...
    cc 220mainAbstracted.c 040pixel.o -lglfw -lGL -lm -ldl
*/
