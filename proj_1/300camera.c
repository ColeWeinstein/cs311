/*
    300camera.c
    A camera class, used for projection transformations. The camera is now treated as its own object in the scene. 
    Upgraded from 280camera.c to include functions to control the camera's position and orientation.
