/*
	200mesh.c
	Creates the meshMesh struct and defines methods to implement it, including meshRender. Differs from 190mesh.c by invoking a vertex shader and implementing varyings.
