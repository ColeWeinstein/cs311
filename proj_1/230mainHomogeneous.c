/*
    230mainHomogeneous.c
    A new main implementing rotation and translation as a 3x3 matrix stored in the mesh's uniforms.
...
On Ubuntu, compile with...
    cc 230mainHomogeneous.c 040pixel.o -lglfw -lGL -lm -ldl
*/
